...
public class BooleanToHorizontalChevronImageConverter : BooleanToHorizontalChevronIconConverter, IHaveIconFont
{
	private readonly IconToImageConverter _converter;

	public BooleanToHorizontalChevronImageConverter()
	{
